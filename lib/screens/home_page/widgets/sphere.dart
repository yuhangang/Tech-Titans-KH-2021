        ...
        child: Stack(
          ...
          children: <Widget>[
            Positioned(
              ...
              top: 0,
              child: Image.asset(
                "assets/images/symptom_light@3x.png",
                width: 260,
                height: 260,
                fit: BoxFit.fill,
              ),
            ...
            Column(
              ...
              children: <Widget>[
                Stack(
                  ...
                  children: <Widget>[
                    Image.asset(
                      "assets/images/symptom_ballwithflare@3x.png",
                ...
                Image.asset(
                  "assets/images/symptom_ball_shadow@3x.png",
                  width: 260,
                  height: 20,
                  fit: BoxFit.fill,
                ),
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < points.length; i++) {
      ...
      if (pointAnimationSequence != null &&
        ...
        print("one2");
        //动画未播放完毕
        if (pointAnimationSequence?.paragraphs.isNotEmpty ?? false) {
          print("one2");
...
class PointAnimationSequence {
  Point point;
  bool needHighLight;
  Queue<ui.Paragraph> paragraphs = Queue();
